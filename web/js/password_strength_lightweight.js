...
;(function ( $, window, document, undefined ) {
    ...
    Plugin.prototype._create = function () {
        ...
        this.element.append(
            ...
            <ul> \
            <li data-criterion="length" class="valid">8-20 <strong>Caracteres</strong></li> \
            <li data-criterion="capital" class="valid"><strong>Mayúsculas</strong></li> \
            <li data-criterion="number" class="valid">Al menos <strong>Un número</strong></li> \
            <li data-criterion="letter" class="valid">Sin espacios</li> \
            </ul> \
            </div>');
    ...
    Plugin.prototype._update_indicator = function(total) {
        ...
        if (total === 0) {
            ...
            meter.addClass('medium').html('<p>Media</p>');
        } else {
