...
<div class="site-about ">
    ...
    <div id="prueba" class="col-md-8 col-xs-6">
            <h3>¿Qué es Phergeon?</h3>
                <p>
                    Phergeon es el resultado del proyecto desarrollado por
                    <a href="">Daniel Gómez Vela</a> con el objetivo de poderle encontrar
            ...
            <h3>¿Cual es el propósito de Phergeon?</h3>
                <p>Esta página ha sido creada con el propósito de centralizar todos esos
